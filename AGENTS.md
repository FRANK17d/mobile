...
This project is indexed by GitNexus as **mobile** (4253 symbols, 10405 relationships, 176 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
