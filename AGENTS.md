...
This project is indexed by GitNexus as **mobile** (4537 symbols, 11134 relationships, 185 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
