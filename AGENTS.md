...
This project is indexed by GitNexus as **mobile** (2705 symbols, 6369 relationships, 173 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
