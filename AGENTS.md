...
This project is indexed by GitNexus as **mobile** (4110 symbols, 10017 relationships, 180 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
